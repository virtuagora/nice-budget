<template>
  <section>
    <default-fields ref="defaultFields" :project.sync="project" :categories="categories" :districts="districts" :editable="true"></default-fields>
    <br>
    <project-fields ref="projectFields" :project.sync="project" :project-fields="projectFields" :editable="true"></project-fields>
    <br>
    <div v-if="projectFields.enable_budget">
      <budget-builder v-if="projectFields.enabled_detailed_budget"  ref="budget" :budget-limit="projectFields.budget_limit" :editable="true"></budget-builder>
      <budget-simple v-else ref="budget" :project.sync="project" :budget-limit="projectFields.budget_limit" :editable="true"></budget-simple>
    </div>
    <hr>
    ...
    <div class="message is-success" v-show="response.replied && response.ok">
      <div class="message-body">
        <i class="fas fa-check fa-fw"></i>&nbsp;<b>¡Genial!</b> El proyecto ha sido guardado correctamente!
      </div>
    </div>
...
export default {
  props: ["formUrl", 'categories', 'districts', 'projectFields'],
  components: {
    DefaultFields,
    ProjectFields,
    BudgetSimple,
