<template>
  <section>
    <admin-notes ref="adminNotes" :project.sync="project" :notes-url="notesUrl"></admin-notes>
    <br>
    ...
    <!-- <form-project-admin ref="FormProjectAdmin" :project.sync="project" :categories="categories" :budget="budget" :editable="true"></form-project-admin> -->
    <hr>
    <button
...
<script>
import AdminNotes from "../../utils/project/AdminNotes";
