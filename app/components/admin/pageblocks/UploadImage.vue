<template>
  <section>
    <div>
      <b-message>
        Subí una imagen para el bloque de texto.
        <br>Tamaño del archivo: 3MB. Se aceptan .JPG, .JPEG, PNG
        <br>
        <b>NOTA: Se recomiendan que las dimensiones sean al menos de un ancho de 1000px y alto de 500 px (De no se así se ajustaran las dimensiones)</b>
      </b-message>
      ...
      <hr>
      <img :src="`/pageblocks/${block.id}/imagen`" alt>
    </div>
