<template>
  <section>
    ...
    <p>Independientemente de si es un proyecto comunitario o institucional, se debe asignar a la presentación del proyecto una persona como responsable para su seguimiento. Los siguientes campos se completarán automáticamente de acuerdo a los datos de su registro. <span class="is-600">Estos campos no serán visibles públicamente, son a efecto de la convocatoria a subir proyectos</span>.</p>
    </div>
    <div class="columns">
      <div class="column">
        <div class="field">
    ...
    <div class="columns">
     ...
     <div class="notification is-primary">
     <h1 class="title is-3"><i class="fas fa-list"></i>&nbsp;Datos del proyecto</h1>
     </div>
    <div class="field">
    ...
    <div class="field">
      <h1 class="title is-4" :class="{'has-text-danger': errors.has('project.title')}">
      ...
      <div class="control">
        ...
        <h1 class="subtitle is-6">
          <span class="has-text-link">* Requerido.</span> Defina el objetivo del proyecto. Tenes un máximo de 1500 caracteres
        </h1>
      <div class="control">
        <b-input
    ...
    <div class="field">
      ...
      <h1 class="subtitle is-6">
          <span class="has-text-link">* Requerido.</span> ¿Cual es la problematica que atiende el proyecto?. Tenes un máximo de 1500 caracteres
      </h1>
      <div class="control">
        <b-input
