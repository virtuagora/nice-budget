...
// MiscActions
$app->get('/installer', 'miscAction:showInstaller')->setName('showInstaller');
$app->post('/installer', 'miscAction:runInstaller')->setName('runInstaller');
$app->get('/install/demo', 'miscAction:runDemoInstaller')->setName('runDemoInstaller');
$app->get('/install/users', 'miscAction:runUsersDemoInstaller')->setName('runDemoInstaller');
...
$app->get('/consultas', 'pagesAction:showConsultas')->setName('showConsultas');
...
$app->group('/api', function () {
    ...
    $this->group('/admin', function () {
        ...
        $this->post('/pageblock','pageblockAction:createOne')->setName('createPageblock');
        $this->put('/pageblock/{blo}','pageblockAction:updateOne')->setName('updatePageblock');
        $this->delete('/pageblock/{blo}','pageblockAction:deleteOne')->setName('deletePageblock');
    });
});
...
$app->group('/admin', function () {
    ...
    $this->get('/stats', 'adminAction:showStats')->setName('showAdminStats');
    $this->get('/roles', 'adminAction:showRoles')->setName('showRoles');
    $this->get('/options', 'adminAction:showOptions')->setName('showOptions');
    $this->group('/pageblocks', function () {
        $this->get('', 'pageblockAction:showPageblocks')->setName('showPageblocks');
        $this->get('/crear', 'pageblockAction:showCreatePageblock')->setName('showCreatePageblock');
        $this->get('/{blo}/editar', 'pageblockAction:showEditPageblock')->setName('showEditPageblock');
        $this->get('/{blo}/imagen', 'pageblockAction:showUploadPageblock')->setName('showUploadImagePageblock');
        $this->post('/{blo}/imagen', 'pageblockAction:runUploadImage')->setName('runUploadImagePageblock');
    });
    $this->get('/customization', 'adminAction:showCustomization')->setName('showCustomization');
});

$app->group('/pageblocks', function () {
    $this->get('/{blo}/imagen', 'pageblockAction:showImage')->setName('showImagePageblock');
});
